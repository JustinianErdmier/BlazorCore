...
/// <summary> Base class for components who correspond to an HTML element - provides common properties for customizing the rendering of the HTML element. </summary>
