...
/// <remarks>
///     Just inherit your dialog wrapping component from this and use the available properties and methods. If you need more control over the close behavior,
///     you can override the <see cref="CloseDialog" /> and <see cref="OnDialogClosed" /> methods.
/// </remarks>
public abstract class CoreDialogWrapper : ComponentBase
{
    ...
    /// <remarks> <b> Note: </b> This property is meant to be two-way bound with the <see cref="CoreDialog.IsShown" /> property.
    ///     <example> <CoreDialog IsShown="@IsDialogShown"> @* your content here... *@ </CoreDialog> </example>
    /// </remarks>
    [ Parameter ]
    ...
    /// <remarks>
    ///     Subscribe the <see cref="CoreDialog.OnClose" /> event to this method to get notified when the <c> dialog </c> is closed. If you need more control
    ///     over the close event behavior, you can override this method.
    /// </remarks>
